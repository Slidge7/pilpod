...
pub fn with_invoke_handler(builder: tauri::Builder<Wry>) -> tauri::Builder<Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        crate::widget::commands::widget_set_expanded,
        crate::widget::commands::widget_set_browsers_open,
        ...
        crate::extension_setup::commands::extension_setup_cancel,
        crate::extension_setup::commands::extension_setup_set_dismissed,
        crate::extension_setup::commands::extension_setup_reset,
...
pub fn with_invoke_handler(builder: tauri::Builder<Wry>) -> tauri::Builder<Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        // The widget is platform-neutral — real commands on all platforms.
        crate::widget::commands::widget_get_state,
        crate::widget::commands::widget_set_enabled,
        crate::widget::commands::widget_set_placement,
        crate::widget::commands::widget_use_free_placement,
