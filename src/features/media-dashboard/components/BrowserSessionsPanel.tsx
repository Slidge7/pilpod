      ...
      {groups.length === 0 ? (
        ...
        <div className="flex flex-col gap-3">
          {groups.map(([browserId, tabs]) => {
            ...
            >
              <header className="flex min-h-[26px] items-center justify-between gap-2 border-b border-zinc-300 bg-zinc-100 px-2 py-0.5 dark:border-zinc-700 dark:bg-zinc-900">
                <span className="min-w-0 truncate text-[10px] font-semibold uppercase tracking-wide text-zinc-600 dark:text-zinc-500">
