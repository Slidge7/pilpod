...
export function IconVolumeMuted({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconReload({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconBrowserClosed({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
...
export function IconStatusConnected({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
...
export function IconStatusOffline({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
...
export function IconStatusReconnecting({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
...
export function IconExtensionMissing({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="12"
    ...
    >
      ...
      <path d="M9 8V2" />
      <path d="M15 8V2" />
      <path d="M6 12H2a10 10 0 0 0 10 10v0a10 10 0 0 0 10-10h-4" />
    </svg>
  );
}

export function IconLaunchBrowser({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconDownloadTray({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconMusicNote({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="14"
...
export function IconRepeatOne({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="15"
